...
namespace NeuralNetwork.NetworkModels
{
	public class Network
	{
        ...
        public Network(int inputSize, int[] hiddenSizes, int outputSize, ILogger logger, double? learnRate = null, double? momentum = null)
            : this(inputSize, hiddenSizes, outputSize, learnRate, momentum)
        {
            _logger = logger;
        }
        #endregion
		...
		public void Train(List<DataSet> dataSets, double minimumError)
		{
			...
			while (error > minimumError && numEpochs < int.MaxValue)
			{
                ...
                var logMessage = string.Format("{0};{1}", numEpochs, error);
